...
- **תאריך:** 04.08.2026 (עודכן 05.08.2026)
- **סטטוס:** **כל Phase 0–5 מומשו בקוד** (מיגרציות 0010–0015 כתובות, טרם הורצו). הכל dormant עד הרצת המיגרציות + הפעלת ה-hook.
...
> **📚 מסמכים קשורים (Runbooks):**
> - [phase-0-plan.md](phase-0-plan.md) — תוכנית יישום מקצה-לקצה של Phase 0 (Foundations): סדר הרצה בטוח, RLS, טסטי בידוד, rollback.
> - [phases-1-5-runbook.md](phases-1-5-runbook.md) — הפעלה ותפעול של Phases 1–5: מיגרציות, hook, env, אימות, תפעול לכל שלב, offboarding, troubleshooting.
