-- ═══════════════════════════════════════════════════════════════════════
-- HACK THE SOC :: APPLY B2B — PART 2 (SAFE / reversible)
-- RLS cut-over + Phases 1-5 features, EXCLUDING the irreversible DROP TABLE
-- of the unused 0001 tables (deferred until a backup / Pro plan exists).
-- No data loss; the RLS changes are reversible via SQL. Run in the SQL editor.
-- ═══════════════════════════════════════════════════════════════════════
...
-- ── 0015 (purge_org only — DROP TABLE statements intentionally omitted) ──
