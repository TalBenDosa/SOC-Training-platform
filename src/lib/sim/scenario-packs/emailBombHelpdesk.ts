  ...
  const events: TelemetryEvent[] = [
    ...
    // ─────────────────────────────────────────────────────────────────────
    {
      ...
      raw: {
        ...
        "data.office365.UserId": victim.upn,
        "data.office365.ClientIP": victim.ip,
        "data.office365.ResultStatus": "True",
        "data.office365.CreationTime": T(11 * MIN),
        // New-InboxRule cmdlet parameters, as O365 UAL actually records them
        "data.office365.Parameters[0].Name": "Name",
        "data.office365.Parameters[0].Value": "Newsletters",
        "data.office365.Parameters[1].Name": "SubjectContainsWords",
        "data.office365.Parameters[1].Value": "[\"confirm\",\"subscribe\"]",
        "data.office365.Parameters[2].Name": "MoveToFolder",
        "data.office365.Parameters[2].Value": "Newsletters",
