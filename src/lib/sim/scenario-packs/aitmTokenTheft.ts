...
export function buildAitmTokenTheftScenario(scenarioId = "aitm-token-theft-2026"): ScenarioBundle {
  ...
  return {
    ...
    briefing: "Entra ID flagged two sign-ins for m.delgado (LT-FIN-0442) six minutes apart from different countries at 07:30. The user reports nothing wrong and is working normally. A separate geo-change alert on a.rosen is attached for comparison.",
    narrative:
