  ...
  const events: TelemetryEvent[] = [
    ...
    // ---------------------------------------------------------------------
    {
      ...
      raw: {
        ...
        "user.email": insider.email,
        "user.name": `NEXACORP\\${insider.sam}`,
        "source.user.name": insider.sam,
        "source.ip": host.ip,
        "source.hostname": host.hostname,
        "url.domain": personalCloud,
        "url.full": `https://${personalCloud}/upload`,
        "url.category": "File Sharing",
        "http.request.method": "POST",
        "http.user_agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36 Edg/128.0.2739.42",
        "network.application": "dropbox",
        "network.protocol": "https",
        "network.transport": "tcp",
        "destination.domain": personalCloud,
        "destination.port": "443",
        "source.bytes": "598291000",
        "destination.bytes": "842100",
        "session.bytes": "599133100",
        "session.duration": "842",
        "session.id": "ZIA-77401322",
        "action": "allowed",
        "action_result": "allow",
      },
    },
