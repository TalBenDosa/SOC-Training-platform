  ...
  const events: TelemetryEvent[] = [
    ...
    // ─────────────────────────────────────────────────────────────────────
    {
      ...
      raw: {
        ...
        "zscaler.url": `https://${c2Domain}/api/v1/gate`,
        "zscaler.hostname": c2Domain,
        "zscaler.urlcategory": "Botnet",
        "zscaler.reqmethod": "GET",
        "zscaler.respcode": 200,
        "zscaler.useragent": malwareUa,
        "zscaler.cip": infected.ip,
        "zscaler.sip": c2Ip,
        "zscaler.serverip": c2Ip,
        "zscaler.respsize": 642,
        "zscaler.appname": "HTTPS",
    ...
    // ─────────────────────────────────────────────────────────────────────
    {
      ...
      raw: {
        "zscaler.action": "Allowed",
        "zscaler.login": victim.sam,
        "zscaler.url": `https://${c2Domain}/files/u.bin`,
        "zscaler.hostname": c2Domain,
        "zscaler.urlcategory": "Botnet",
        "zscaler.reqmethod": "GET",
        "zscaler.respcode": 200,
