  ...
  const events: TelemetryEvent[] = [
    ...
    // ── 7. Payload download ───────────────────────────────────────────────────
    {
      ...
      raw: {
        ...
        "crowdstrike.parent_basefilename": "bash",
        "crowdstrike.username": "svc-backup",
        "crowdstrike.uid": "1004",
        "crowdstrike.gid": "1004",
        "crowdstrike.sha256": makeSha256("usr_bin_curl_ubuntu2204"),
        "host.os.type": "linux",
        "host.os.name": "Ubuntu",
    ...
    // ── 10. Miner execution ───────────────────────────────────────────────────
    {
      ...
      raw: {
        ...
        "crowdstrike.parent_basefilename": "bash",
        "crowdstrike.parent_process_id": "1877",
        "crowdstrike.username": "svc-backup",
        "crowdstrike.uid": "1004",
        "crowdstrike.gid": "1004",
        "crowdstrike.sha256": minerHash,
        "host.os.type": "linux",
        "host.os.name": "Ubuntu",
        "host.hostname": host.fqdn,
        "event.outcome": "success",
    ...
    // ── 12. BENIGN DISCRIMINATOR — legitimate high-CPU batch job ──────────────
    {
      ...
      raw: {
        ...
        "crowdstrike.parent_basefilename": "cron",
        "crowdstrike.parent_process_id": "1102",
