  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      // ── Reading 1 ──────────────────────────────────────────────
      {
        ...
        checkpoint: {
          question: "According to the reading, which CloudTrail userIdentity.type value should almost never appear, and is a major red flag when it does?",
          options: ["IAMUser", "AssumedRole", "Root", "ServicePrincipal"],
          answer: 2,
          explanation:
            "Root is the all-powerful account root user, which should almost never appear performing routine actions in CloudTrail — best practice is to lock the root account away and use IAM users/roles for day-to-day work, so root activity is a strong signal worth investigating.",
        },
      },
      // ── Reading 2 ──────────────────────────────────────────────
      {
